...
$qr = "select email from al_det";
$result = mysqli_query($cxn, $qr);
if($result) {
	
	for($i = 0; $i < mysqli_num_rows($result); $i++) {
		$row = mysqli_fetch_row($result);
		$to = "$row[0]";
		$subject = "Admin Message, SMU Alumni";
		$message = "$msg";
		$headers = "From,<br />Admin (SMU Alumni)";
...
<!--<div align = "right"><a href="settings.php" ><u>Settings</u></a></div></br>-->
		...
		<br /><br />
<div class="main_head">
                        <span id = "success"><img src = "tick.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;&nbsp;<font size = "2" color = "green">MESSAGE SUCCESSFULLY SENT</font></span>&nbsp;
                    </div>
<br /><br />
								...
								<td valign="top"><div webpartid="b5ace897-7501-4a4e-8c88-3c266a4ec979" haspers="false" id="WebPartWPQ2" width="100%" class="ms-WPBody" allowdelete="false" style="">
									...
									<ul class="form">
										<li>
											...
											<br /><br />
											<textarea name="adminnews" rows="20" cols="20" placeholder = "Should not Exceed 400 Characters" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtCAddress" class="required" style="border:solid 2px #DDD;height:150px;width:500px;padding-top:5px;padding-left:5px;"></textarea>
										</li>
										<li></li>
										</br><li align = "center">
											<table border = "0" width = "510">
									...
									<div style = "background-color:hsl(0, 0%, 95%); border-radius: 10px; padding:18px 20px 10px 20px;">';
									...
									$page = (isset($_GET['pages20'])) ? (int)$_GET['pages20'] : 1;
									...
									if($result){
										if(mysqli_num_rows($result) > 0) {
											...
											while($row = mysqli_fetch_assoc($result)){
												...
												if($sizeOfSplit > 20) {
													echo "<a href = '#' title = 'Expand Post' style = 'text-decoration : none;' class='big-link'  data-reveal-id='myModal2'>".$title."....</a>
													<div id='myModal2' class='reveal-modal' >
														<h1><font size='5' color='black' style='font-family:segoe ui;'> <b>$title.... -</b></font></h1><br>
														<p><font size='4' color='#3a6d8c'style='font-family:segoe ui;'>".$row['post']."</font></p>
														<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size='3' color='black' style='font-family:segoe ui;'>- By ".$row['postedBy']."</font></p>
														<a class='close-reveal-modal'>&#215;</a>
													</div>";
												} else {
													echo $row['post'];
												}
												echo "</b></font> <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size = '4'>- By ";
												echo "<font color = '#794916'><b>Admin</b></font>";
												echo " on <font color = '#794916'><b>".htmlspecialchars($row['postedOn'])."</b></font> </font><br /><br />";
											...
											if($pages > 1 && $page <= $pages) {
												...
												for($x = 1; $x <= $pages; $x++) {
													echo '<a href = "?pages20='.$x.'" style = "text-decoration:none;">';
													if($page == $x){
									...
									if($result1){
										if(mysqli_num_rows($result1) > 0) {
											...
											while($row = mysqli_fetch_assoc($result1)){
												...
												<td width = '500'><font size = '5' style = 'color:#b57f47;'><b>";
												if($sizeOfSplit > 20) {
													echo "<a href = '#' title = 'Expand Post' style = 'text-decoration : none;' class='big-link'  data-reveal-class='reveal-modal'>".$title."....</a>
												...
												echo "</b></font> <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size = '4'>- By <a style = 'text-decoration : none;' href = 'viewProfile.php?reg_no=".htmlspecialchars($row['reg_no'])."'><b>".htmlspecialchars($row['postedBy'])."</b></a> on <font color = '#794916'><b>".htmlspecialchars($row['postedOn'])."</b></font> </font><br /><br />
