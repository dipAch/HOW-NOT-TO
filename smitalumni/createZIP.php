...
$file_recieved = mysqli_real_escape_string($cxn, $_GET['filename']);
$actual_file_name = $file_recieved;
$file_recieved = "newsletter\\".$file_recieved;

function create_zip($files = array(), $destination = '', $overwrite = false) { /* creates a compressed zip file */
...
$tempo = explode(".", $actual_file_name);
$result = create_zip($files_to_zip, "newsletter\\".$tempo[0].'.zip');

if($result) {
	$now = date("l, F jS, Y \a\\t g:i a", time());
	$pdfquery = "INSERT INTO newsletter(pdffile, uploadedOn) VALUES('$actual_file_name', '$now')";
	$pdfresult = mysqli_query($cxn, $pdfquery);
	if($pdfresult) {
...
<br /><br />
<div class="main_head">
                        <span id = "success"><img src = "tick.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;&nbsp;<font size = "2" color = "green">UPLOAD SUCCESSFUL</font></span>&nbsp;
                    </div>
<br /><br />
...
<span style="font-family: "><br />
	...
	header("Location: error.php?ref=newsup");
...
<br /><br />
<div class="main_head">
									<span id = "error"><img src = "cross.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;<font size = "2" color = "red"><b>UPLOAD UNSUCCESSFUL, COULD NOT CREATE ZIP</b></font></span>&nbsp;
							  </div>
<br /><br />
