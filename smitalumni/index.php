...
<script src="jS/jquery.paulund_modal_box1.js"></script>
		...
		<div id="content-area">
			<div class="lt-pnl">
				<div class="panel">
					...
					<div class="pnl-cont">
						<ul>
							<li><font color="white">Alumni Home</font></li>
							<li class="act">
								<div class="top"></div>
						    ...
						    <li class="act">
								<div class="top"></div>
								<div class="mid"><a href="by.php">Bylaws & Constitution</a></div>
								<div class="bot"></div>
							</li>
						<li class="act">
								<div class="top"></div>
								<div class="mid"><a href="contacts.php">Contacts</a></div>
								<div class="bot"></div>
							</li>
...
<div class="lt">&nbsp;</div>
<div class="rt">Alumni Home</div>
</div>

<br />
                    <div class="main_head">
                        <font size = "5" color = "#b57f47"> Welcome to Alumni Association</font>
						
						<button class="btn btn-4 btn-4a icon-arrow-right modal_login" >Login</button>
			&nbsp;
 </div>		
...
<br /><font size = "2" color = "#b57f47"><strong>SMU Alumni Association</strong></font>
</td>
</tr>
</table>
</div>
...
<script type="text/javascript">
	stLight.options({publisher: "67c8613c-31c1-46b7-972b-f342ee4dc00a", doNotHash: false, doNotCopy: false, hashAddressBar: false});
</script>
</body>
</html>