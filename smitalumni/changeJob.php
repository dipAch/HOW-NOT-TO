<?php
	...
	include 'copyrt.php';
	@$job = mysqli_real_escape_string($cxn, $_POST['p_job']);
	if(isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
		$reg = mysqli_real_escape_string($cxn, $_COOKIE['reg']);
		if(!empty($job)) {
		$query = "UPDATE al_det SET job = '$job' WHERE reg_no = '$reg'";
...
function changeColor(){
	document.getElementById("ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_job").style.border = "1px solid hsl(0, 0%, 67%)";
}
		...
		<td>
			<table width="150%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr><form action = "changeJob.php" name = "editJob" method = "post">
					...
					<td>
						<input name="p_job" type="text" value = "'.htmlspecialchars($_POST['p_job']).'" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_job" class="required" style="width:250px;border:1px solid red;height:20px;padding-left:3px;" onFocus = "changeColor()" />
					   <input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
