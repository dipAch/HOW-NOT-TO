<?php
	...
	if(isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
		...
		extract($row);
		$query1 = "SELECT post FROM feed WHERE post_id = $contr_post and reg_no = '$reg'";
...
echo '<form action = "update_contr.php" name = "edit_contribute" method = "post">
									<ul class="form">
										<li>
											...
											<br /><br />
											<textarea name="ed_contribute" placeholder = "Should not exceed 1000 Characters and be less than 35 characters" rows="20" cols="20" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtCAddress" class="required" style="border:solid 2px #DDD;height:150px;width:500px;padding-top:5px;padding-left:5px;">'.strip_tags($row[0]).'</textarea>
										</li>
										<li><input type = "hidden" name = "postid" value = "'.$contr_post.'" /></li>
										<li align = "center">
