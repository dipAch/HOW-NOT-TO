<?php
	...
	if (!$error) {
		...
		$query0 = "SELECT photo_id FROM al_det where reg_no = '$reg'";
		$result0 = mysqli_query($cxn, $query0);
		if($result0) {
		$row = mysqli_fetch_row($result0);
		if($row[0] != "unknown.png" && file_exists("photo\\$row[0]")) {
			unlink("photo\\$row[0]");
		}
		// Mod Change Img Name
		$queryPic = "SELECT person_id FROM al_det where reg_no = '$reg'";
		...
		$query = "UPDATE al_det SET photo_id = '$image' where reg_no = '$reg'";
...
<table width="500" border="0" cellpadding="0" cellspacing="0" style="">
	<tr>
		<td> 
			...
			if($err_pic_type){
				echo '<br><br><img src = "caution1.png" width = "15" height = "15" valign = "middle" />&nbsp;&nbsp;<font size = "1" color = "#FF0000"><b>FILE NOT AN IMAGE</b></font><br>';
			}
			if($err_pic_width) {
				echo '<br><br><img src = "caution1.png" width = "15" height = "15" valign = "middle" />&nbsp;&nbsp;<font size = "1" color = "#FF0000"><b>IMAGE WIDTH TOO LARGE</b></font><br>';
			}
			if($err_pic_height) {
				echo '<br><br><img src = "caution1.png" width = "15" height = "15" valign = "middle" />&nbsp;&nbsp;<font size = "1" color = "#FF0000"><b>IMAGE HEIGHT TOO LARGE</b></font><br>';
			}
			if($err_pic_format) {
				echo '<br><br><img src = "caution1.png" width = "15" height = "15" valign = "middle" />&nbsp;&nbsp;<font size = "1" color = "#FF0000"><b>IMAGE FORMAT NOT SUPPORTED</b></font><br>';
			}
			echo '<br />
						<span class="information">(You can upload a JPG, GIF, JPEG or BMP file (Maximum size of 1MB). Images dimension should</span><br>
						<span class="information">not be more than Width 300px Height 300px)</span>
