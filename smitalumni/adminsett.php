...
if (isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
	...
	$qr= "update admin_login set pass = '$pass' where name = 'admin'";
...
<!--<div align = "right"><a href="settings.php" ><u>Settings</u></a></div></br>-->
		...
		<br /><br />
<div class="main_head">
                        <span id = "success"><img src = "tick.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;&nbsp;<font size = "2" color = "green">PASSWORD SUCCESSFULLY UPDATED</font></span>&nbsp;
                    </div>
<br /><br />
										...
										if(mysqli_num_rows($result) > 0) {
											...
											while($row = mysqli_fetch_assoc($result)){
												...
												if($sizeOfSplit > 20 && $count > 20) {
													...
													echo "<a href = '#' title = 'Expand Post' style = 'text-decoration : none;' class='big-link'  data-reveal-id='myModal2'>".$titleLong."....</a>
													<div id='myModal2' class='reveal-modal' >
									...
									if($result1){
										if(mysqli_num_rows($result1) > 0) {
											...
											while($row = mysqli_fetch_assoc($result1)){
												...
												<td width = '500'><font size = '5' style = 'color:#b57f47;'><b>";
												if($sizeOfSplit > 20 && $count > 20) {
													echo "<a href = '#' title = 'Expand Post' style = 'text-decoration : none;' class='big-link'  data-reveal-id='myModal'>".$title."....</a>
													...
													echo "<a href = '#' title = 'Expand Post' style = 'text-decoration : none;' class='big-link'  data-reveal-id='myModal'>".$titleLong."....</a>
													<div id='myModal' class='reveal-modal' >
														<h1><font size='5' color='black' style='font-family:segoe ui;'> <b>$titleLong.... -</b></font></h1><br>
														<p><font size='4' color='#3a6d8c'style='font-family:segoe ui;'>".$row['post']."</font></p>
														<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size='3' color='black' style='font-family:segoe ui;'>- By ".$row['postedBy']."</font></p>
												...
												echo "</b></font> <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size = '4'>- By <a style = 'text-decoration : none;' href = 'adminviewProfile.php?reg_no=".htmlspecialchars($row['reg_no'])."'><b>".htmlspecialchars($row['postedBy'])."</b></a> on <font color = '#794916'><b>".htmlspecialchars($row['postedOn'])."</b></font> </font><br /><br />
