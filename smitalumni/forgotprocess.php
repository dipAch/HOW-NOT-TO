...
$query1 = "SELECT email FROM bck_up WHERE reg_no = '$reg'";
...
if(mysqli_num_rows($result1) > 0){
	...
	$query2 = "SELECT pass FROM bck_up WHERE reg_no = '$reg'";
	$result2 = mysqli_query($cxn, $query2);
	$row2 = mysqli_fetch_assoc($result2);
	$to = $row1['email'];
	$subject= "Your Smit Alumni password";
	$message= 'Dear Alumni,<br /><br />Your Password : <b>'.$row2['pass'].'</b><br /><br />Regards,<br /><b>Alumni Team</b>,<br />SMU.';
	$from= "http://www.alumni.smu.edu.in";
	$headers= "From : ".$from;
...
<div id="container">
	...
	<div class="wrapper">
		<div class="ticker">
			...
			<div class="rt">
				<marquee onmouseover="this.scrollAmount=0" onmouseout="this.scrollAmount=1" truespeed="" scrollamount="3" scrolldelay="20">
...
<br>
                    <div class="main_head">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "success"><img src = "tick.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;&nbsp;<font size = "2" color = "green">Your Account Details Have Been Sent To Your Email-ID</font></span>&nbsp;
                    </div>
		...
		<div id="content-area">
			<div class="lt-pnl">
				<div class="panel">
					...
					<div class="pnl-cont">
						<ul>						
						    <li><font color="white">Forgot Password</font></li>
							<li class="act">
								<div class="top"></div>
								<div class="mid"><a href = "index.php">Alumni Login</a></div>
								<div class="bot"></div>
							</li>							
						</ul>
					</div>
...
<div class="page-heading">
<div class="lt">&nbsp;</div>
<div class="rt">Account Recovery</div>
</div>
<br>';
					if($error) {
					...
					if($err_format) {
						echo '<div class="main_head">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "error"><img src = "caution.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;<font size = "2" color = "red"><b>MUST BE A VALID REGISTRATION NO.</b></font></span>&nbsp;
							  </div>';	
					}
					if($db_err) {
						echo '<div class="main_head">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "error"><img src = "caution.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;<font size = "2" color = "red"><b>REGISTRATION NO. DOES NOT EXIST</b></font></span>&nbsp;
							  </div>';	
					}
echo '<div id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_AlumniLoginPanel" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit&#39;)">
<br />	
<form action="forgotprocess.php" name="forgot_pass_form" method="post">   	
<table width="500" border="0" cellpadding="0" cellspacing="0" style="border: #905a2b 0px solid;">	
	<tr>
		<td style="border: #905a2b 1px solid;border-radius:10px">
			<table width="80%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr>
					...
					<td>
						<input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" onclick="return validateForm();WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$m$g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d$ctl00$ibtnSubmit&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" style="height:26px;width:28px;border-width:0px;outline:none;">
					</td>
				</tr>
				<tr>
					<td>
	...
	header("Location: error.php?ref=forgot");
