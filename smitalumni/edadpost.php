<?php
	...
	if(isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
		...
		extract($row);*/
		$query1 = "SELECT post FROM ad_post WHERE post_id = $adpost_post";
...
echo '<form action = "update_adpost.php" name = "edit_adpost" method = "post">
									<ul class="form">
										<li>
											...
											<br /><br />
											<textarea name="ed_adpost" placeholder = "Should not exceed 1000 Characters" rows="20" cols="20" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtCAddress" class="required" style="border:solid 2px #DDD;height:150px;width:500px;padding-top:5px;padding-left:5px;">'.strip_tags($row[0]).'</textarea>
										</li>
										<li><input type = "hidden" name = "postid" value = "'.$adpost_post.'" /></li>
										<li align = "center">
