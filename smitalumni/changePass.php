<?php
	...
	include 'copyrt.php';
	@$pass = mysqli_real_escape_string($cxn, $_POST['pass']);
	if(isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
		$reg = mysqli_real_escape_string($cxn, $_COOKIE['reg']);
		if(!empty($pass)) {
		if(strlen($pass) >= 6){
		$query1 = "UPDATE bck_up SET pass = '$pass' WHERE reg_hash = '$reg'";
		$result1 = mysqli_query($cxn, $query1);
		if($result1) {
		$pass = md5($SECURE.$pass);
		$query2 = "UPDATE al_det SET pass = '$pass' WHERE reg_no = '$reg'";
		$result2 = mysqli_query($cxn, $query2);
		if($result2) {
		$query = "UPDATE login_table SET pass = '$pass' WHERE reg_no = '$reg'";
...
function changeColor(){
	document.getElementById("ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_pass").style.border = "1px solid hsl(0, 0%, 67%)";
}
...
echo '<tr><td colspan = "3" align = "center"><div class="main_head">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "error"><img src = "caution.png" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;<font size = "2" color = "red"><b>MINIMUM 6 CHARACTERS</b></font></span>&nbsp;
							  </div>';
							  }
echo '</td></tr><br />
	<br />
		...
		<td> 
			<table width="100%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr><form name = "editEmail" action = "changeEmail.php" method = "post">
					...
					<td>
						<input name="email_id" type="text" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_email" class="required" style="width:250px;height:20px;padding-left:3px;" /></td>
						<td>
						<input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
					</td>
					</form>
				...
				<tr><form action = "changePass.php" name = "editPass" method = "post">
					...
					<td>
						<input name="pass" type="password" value = "'.htmlspecialchars($_POST['pass']).'" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_pass" class="required" style="width:250px;border:1px solid red;height:20px;padding-left:3px;border-radius:0px;" onFocus = "changeColor()">
					</td>				
					<td>
						<input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
					</td>
		...
		<td>
			<table width="150%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr><form action = "changeCountry.php" name = "editCountry" method = "post">
					...
					<td>
						<input name="p_country" type="text" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_country" class="required" style="width:250px;height:20px;padding-left:3px;" />
						<input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
					</td>				
					</form>
				</tr>
				<tr><form action = "changeJob.php" name = "editJob" method = "post">
					...
					<td>
						<input name="p_job" type="text" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_job" class="required" style="width:250px;height:20px;padding-left:3px;" />
					   <input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
...
if($err) {
echo '<tr><td colspan = "3" align = "center"><div class="main_head">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id = "error"><img src = "caution.jpg" width = "25" height = "25" valign = "middle" />&nbsp;&nbsp;<font size = "2" color = "red"><b>FIELD CANNOT BE EMPTY</b></font></span>&nbsp;
							  </div>';
							  }
echo '</td></tr><br />
	<br />
	...
	<tr>
		<td>
			<table width="150%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr><form action = "changeQualificaton.php" name = "editQualification" method = "post">
					<td align="right">
						<span class="style8"><font size = "2"color = "#b57f47"><b>Qualification ++ : &nbsp;</b></font></span>
					</td>
					<td>
