<?php
	...
	include 'copyrt.php';
	@$blog = mysqli_real_escape_string($cxn, $_POST['blog']);
	if(isset($_COOKIE['reg']) && $_SESSION['loggedIn'] == "yes") {
		$reg = mysqli_real_escape_string($cxn, $_COOKIE['reg']);
		if(!empty($blog)) {
		$query = "UPDATE al_det SET blog = '$blog' WHERE reg_no = '$reg'";
...
function changeColor(){
	document.getElementById("ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_blog").style.border = "1px solid hsl(0, 0%, 67%)";
}
		...
		<td>
			<table width="150%" border="0"  align="center" cellpadding="5" cellspacing="4">
				...
				<tr><form action = "changeBlog.php" name = "editBlog" method = "post">
					...
					<td>
						<input name="blog" type="text" value = "'.htmlspecialchars($_POST['blog']).'" maxlength="50" id="ctl00_m_g_b5ace897_7501_4a4e_8c88_3c266a4ec979_ctl00_txtName_blog" class="required" style="width:250px;border:1px solid red;height:20px;padding-left:3px;" onFocus = "changeColor()" />
					   <input type="image" name="submit" id="ctl00_m_g_e88eaf05_1c32_4c3e_ac47_cb38eaf84d5d_ctl00_ibtnSubmit" src="arrowbutton.jpg" style="height:26px;width:28px;border-width:0px;outline:none;">
